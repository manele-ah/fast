...
/**
 * This is the item provider adapter for a {@link fr.ubo.fast.Data} object. <!--
		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(FastPackage.Literals.DATA__TIME_SERIES_DATA);
			childrenFeatures.add(FastPackage.Literals.DATA__SENSORS_DATA);
		}
	...
	{
		return getString("_UI_Data_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(
				createChildParameter(FastPackage.Literals.DATA__TIME_SERIES_DATA, FastFactory.eINSTANCE.createTimeSeries()));

		newChildDescriptors
				.add(createChildParameter(FastPackage.Literals.DATA__SENSORS_DATA, FastFactory.eINSTANCE.createSensor()));
	}
