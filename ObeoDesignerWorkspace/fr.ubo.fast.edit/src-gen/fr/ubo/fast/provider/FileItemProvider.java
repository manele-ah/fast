...
/**
 * This is the item provider adapter for a {@link fr.ubo.fast.File} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class FileItemProvider extends DataSourceItemProvider
{
	/**
	...
	protected void addPathPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				FastPackage.Literals.FILE__PATH, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ? getString("_UI_File_type") : getString("_UI_File_type") + " " + label;
	}
