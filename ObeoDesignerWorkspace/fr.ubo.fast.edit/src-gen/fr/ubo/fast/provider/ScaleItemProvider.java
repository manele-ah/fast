...
/**
 * This is the item provider adapter for a {@link fr.ubo.fast.Scale} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class ScaleItemProvider extends NamedElementItemProvider
{
	/**
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ? getString("_UI_Scale_type")
				: getString("_UI_Scale_type") + " " + label;
	}
