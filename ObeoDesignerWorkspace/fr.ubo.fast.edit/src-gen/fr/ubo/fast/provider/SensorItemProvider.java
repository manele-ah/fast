...
/**
 * This is the item provider adapter for a {@link fr.ubo.fast.Sensor} object.
...
public class SensorItemProvider extends NamedElementItemProvider
{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(FastPackage.Literals.SENSOR__SENSOR_META_DATA);
			childrenFeatures.add(FastPackage.Literals.SENSOR__SENSOR_MEASURED_VARIABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(
				createChildParameter(FastPackage.Literals.SENSOR__SENSOR_META_DATA, FastFactory.eINSTANCE.createMetaData()));

		newChildDescriptors.add(createChildParameter(FastPackage.Literals.SENSOR__SENSOR_MEASURED_VARIABLES,
				FastFactory.eINSTANCE.createMeasuredVariable()));
	}
