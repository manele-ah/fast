 ...
 * </p>
 * <ul>
 *   <li>{@link fr.ubo.fast.impl.NamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedElementImpl extends MinimalEObjectImpl.Container implements NamedElement
{
	...
	{
		return FastPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FastPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
		case FastPackage.NAMED_ELEMENT__NAME:
			return getName();
		}
